...
export PATH=$HOME/.config/tmux/plugins/t-smart-tmux-session-manager/bin:$HOME/Library/Python/3.11/bin:/opt/homebrew/opt/ruby/bin:$HOME/nvim-macos/bin:$HOME/bin:$HOME/.local/bin:$HOME/go/bin:$HOME/dotfiles/bin:/opt/homebrew/bin:/usr/local/bin:$PATH
