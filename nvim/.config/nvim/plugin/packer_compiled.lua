...
_G.packer_plugins = {
  ...
  fd = {
    loaded = true,
    path = "/Users/thomas/.local/share/nvim/site/pack/packer/start/fd",
  ...
  ["nvim-dap-go"] = {
    loaded = true,
    path = "/Users/thomas/.local/share/nvim/site/pack/packer/start/nvim-dap-go",
  ...
  ["onedark.vim"] = {
    loaded = true,
    path = "/Users/thomas/.local/share/nvim/site/pack/packer/start/onedark.vim",
  ...
  ["toggle-lsp-diagnostics.nvim"] = {
    loaded = true,
    path = "/Users/thomas/.local/share/nvim/site/pack/packer/start/toggle-lsp-diagnostics.nvim",
