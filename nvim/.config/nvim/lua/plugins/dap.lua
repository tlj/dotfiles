local M = {
  ...
  keys = {
    ...
    { "<leader>de", function() require("dapui").eval() end, desc = "Eval debug", mode = {"n", "v"} },
    { '<leader>dB', '<cmd>lua require"dap".set_brakpoint(vim.fn.input("Breakpoint condition: "))<cr>', desc = "Conditional breakpoint" },
