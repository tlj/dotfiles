local prompts = {
	...
	Tests = "Generate complete unit tests for this code. All of the methods and all edge cases. Preferably table tests.",
...
return {
	{
		...
		enabled = require("config.util").is_enabled("CopilotC-Nvim/CopilotChat.nvim"),
		-- version = "v2.10.0",
		...
		config = function(_, opts)
			...
			-- These are only for the chat buffer
